...
from aletheia.adapters.utils import format_field_value, get_annotation_name, parse_value
...
def prepare_instructions(signature: SignatureMeta):
    ...
    def field_metadata(field_name, field_info):
        ...
        if get_aletheia_field_type(field_info) == "input" or field_type is str:
            desc = ""
