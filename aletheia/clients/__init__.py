...
from aletheia.clients.base_lm import BaseLM, inspect_history
...
DISK_CACHE_DIR = os.environ.get("aletheia_CACHEDIR") or os.path.join(Path.home(), ".aletheia_cache")
DISK_CACHE_LIMIT = int(os.environ.get("aletheia_CACHE_LIMIT", 3e10))  # 30 GB default
