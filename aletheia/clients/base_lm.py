...
class BaseLM(ABC):
    ...
    Most users can directly use the `aletheia.LM` class, which is a subclass of `BaseLM`. Users can also implement their
    ...
    print(aletheia.Predict("q->a")(q="Why did the chicken cross the kitchen?"))
    ```
    """
