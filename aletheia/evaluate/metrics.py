# TODO: This should move internally. Same for passage_match. aletheia.metrics.answer_exact_match, aletheia.metrics.answer_passage_match


def _passage_match(passages: list[str], answers: list[str]) -> bool:
    """Returns True if any of the passages contains the answer."""
    from aletheia.dsp.utils import DPR_normalize, has_answer, normalize_text
...
def _answer_match(prediction, answers, frac=1.0):
    ...
    from aletheia.dsp.utils import EM, F1
