...
from aletheia.clients import Embedder
from aletheia.primitives import Example
...
class KNN:
    def __init__(self, k: int, trainset: list[Example], vectorizer: Embedder):
        ...
        Example:
            ...
            trainset = [
                aletheia.Example(input="hello", output="world"),
                # ... more examples ...
            ]
            ...
            knn = KNN(
                k=3,
                trainset=trainset,
                vectorizer=aletheia.Embedder(SentenceTransformer("all-MiniLM-L6-v2").encode)
            )
