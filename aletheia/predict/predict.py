...
from aletheia.clients.base_lm import BaseLM
...
from aletheia.dsp.utils import settings
from aletheia.adapters.chat_adapter import ChatAdapter
...
class Predict(Module, Parameter):
    ...
    def load_state(self, state):
        ...
        if "extended_signature" in state:  # legacy, up to and including 2.5, for CoT.
            raise NotImplementedError("Loading extended_signature is no longer supported in aletheia 2.6+")
