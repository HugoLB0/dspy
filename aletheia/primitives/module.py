...
from aletheia.utils.saving import get_dependency_versions
...
class BaseModule:
    ...
    def named_parameters(self):
        ...
        import aletheia
        from aletheia.predict.parameter import Parameter
        ...
        def add_parameter(param_name, param_value):
            ...
            elif isinstance(param_value, aletheia.Module):
        ...
        for name, value in self.__dict__.items():
            ...
            elif isinstance(value, aletheia.Module):
                # When a sub-module is pre-compiled, keep it frozen.
    ...
    def save(self, path, save_program=False):
        ...
        critical dependencies or aletheia version.
        ...
        if save_program:
            ...
            try:
                ...
                raise RuntimeError(
                    f"Saving failed with error: {e}. Please remove the non-picklable attributes from your aletheia program, "
        ...
        if path.suffix == ".json":
            try:
                ...
                raise RuntimeError(
                    f"Failed to save state to {path} with error: {e}. Your aletheia program may contain non "
    ...
    def load(self, path):
        """Load the saved module. You may also want to check out aletheia.load, if you want to
