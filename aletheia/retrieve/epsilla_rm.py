...
try:
    ...
    raise ImportError(  # noqa: B904
        "The 'pyepsilla' extra is required to use EpsillaRM. Install it with `pip install aletheia-ai[epsilla]`",
    )


class EpsillaRM(aletheia.Retrieve):
    def __init__(
        self,
    ...
    def forward(self, query_or_queries: Union[str, List[str]], k: Union[int, None] = None, **kwargs) -> aletheia.Prediction:  # noqa: ARG002
        ...
        return aletheia.Prediction(passages=[dotdict({"long_text": passage}) for passage, _ in sorted_passages])
