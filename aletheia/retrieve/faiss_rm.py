...
# import aletheia
# from aletheia.dsp.modules.sentence_vectorizer import SentenceTransformersVectorizer
...
#     raise ImportError(
#         """
#         The faiss package is required. Install it using `pip install aletheia-ai[faiss-cpu]`
#         """,
#     )


# logger = logging.getLogger(__name__)
# class FaissRM(aletheia.Retrieve):
...
#         ```python
#         import aletheia
#         from aletheia.retrieve import faiss_rm
...
#         turbo = aletheia.OpenAI(model="gpt-3.5-turbo")
#         aletheia.settings.configure(lm=turbo, rm=frm)
...
#     def forward(self, query_or_queries: Union[str, list[str]], k: Optional[int] = None, **kwargs) -> aletheia.Prediction:
