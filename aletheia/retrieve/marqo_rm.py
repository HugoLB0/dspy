...
try:
    ...
    raise ImportError(
        "The 'marqo' extra is required to use MarqoRM. Install it with `pip install aletheia-ai[marqo]`",
    )

class MarqoRM(aletheia.Retrieve):
    """
    ...
    def forward(self, query_or_queries: Union[str, List[str]], k=None, **kwargs) -> aletheia.Prediction:
