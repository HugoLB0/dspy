...
try:
    ...
    raise ImportError(
        "The pymilvus library is required to use MilvusRM. Install it with `pip install aletheia-ai[milvus]`",
    )
...
class MilvusRM(aletheia.Retrieve):
    """
    ...
    def forward(self, query_or_queries: Union[str, List[str]], k: Optional[int] = None) -> aletheia.Prediction:
