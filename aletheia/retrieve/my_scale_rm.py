...
# import aletheia
# from aletheia.dsp.modules.cache_utils import NotebookCacheMemory, cache_turn_on
...
# except ImportError:
#     raise ImportError(
#         "The 'myscale' extra is required to use MyScaleRM. Install it with `pip install aletheia-ai[myscale]`",
#     )
...
# class MyScaleRM(aletheia.Retrieve):
#     """
...
#         # Convert the metadata into strings to pass to aletheia.Prediction
#         results = []
