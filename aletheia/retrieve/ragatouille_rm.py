...
class RAGatouilleRM(aletheia.Retrieve):
    ...
    Examples:
        ...
        aletheia.settings.configure(lm=llm, rm=rm)
        ```
    """
    ...
    def forward(self, query_or_queries: Union[str, list[str]], k: Optional[int]) -> aletheia.Prediction:
        ...
        return aletheia.Prediction(passages=passages)